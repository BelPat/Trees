...
public class GraphicTree<T extends Comparable<T>> extends JPanel {
     ...
     * @param n:Objeto de la clase BNode <T> que se utiliza como
     ...
     * va a ser dibujado.
     * @param n: Objeto de tipo BNode <T> que se utiliza como
     ...
     * @param n: Objeto de la clase BNode <T> que se utiliza como referencia para dibujar el árbol.
